...
public class ChatMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("F1"),action.getValue(Action.NAME));
        jScrollPane1.getActionMap().put(action.getValue(Action.NAME), action);
