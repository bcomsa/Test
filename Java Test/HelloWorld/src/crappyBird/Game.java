...
public class Game extends JPanel{
	...
	Wall wall = new Wall(WIDTH*2);					//makes the first wall you see
	Wall wall2 = new Wall(WIDTH*2 + (WIDTH / 2));		//makes the second wall you see
	...
	public void paint(Graphics g){
		...
		wall2.paint(g);			//the second wall
 		...
 		g.drawString(deathMessage, 150, 200);				//paints "" if the player has not just died, paints "you died, try again" if the user just died
	}
